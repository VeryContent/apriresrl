  ...
  render() {
    ...
    return (
      <Layout>
        ...
        <p>Porte e persiane non sono solo semplici elementi di architettura di interni ed esterni, ma, nel caso di modelli specifici e innovativi, possono costituire veri e propri sistemi di sicurezza. Noi di Aprire Srl ci occupiamo anche dell’<b>installazione porte e persiane di sicurezza</b> per il benessere e la tutela tuoi e quelli delle persone che ami. Insieme a noi puoi progettare su misura l’ingresso dei tuoi sogni, a prova di effrazione.  </p>
        <h2>Ingressi, inferriate e tapparelle di sicurezza per la protezione dei tuoi cari</h2>
        <p>Gli strumenti per la sicurezza domestica devono essere affidabili <span style={{color:"red"}}>E</span> resistenti, ma al tempo stesso devono integrarsi con lo stile e il design della casa. In quanto realtà specializzata da oltre due decadi nell’installazione di porte e persiane, per privati e per contesti industriali, possiamo offrire un’ampia gamma di porte e persiane blindate, ingressi e tapparelle di sicurezza o inferriate.</p>
